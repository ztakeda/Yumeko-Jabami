...
module.exports = {
    ...
    start: async(yumeko, m, { text }) => {
        if (text.toLowerCase() === "random") {
            ...
            //yumeko.sendFile(m.from, fetch.result.img, "", m, { caption }) yg gambarnya kena internet positif
            ...
            //yumeko.sendFile(m.from, fetch.result[0].img, "", m, { caption }) yg gambarnya kena internet positif
            yumeko.sendText(m.from, caption, m)
        } else {
